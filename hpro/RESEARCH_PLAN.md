...
Adopt lambda_terminal=2.0 and guide_min_new=15, re-derived jointly over a paired 5-seed …
Add the outdated-mesh go/no-go experiment: belief-aware receding horizon vs open-loop …
Record the Stage B evidence: guided 5-seed eval, guide-off ablation, outdated-mesh …
```
